...
class LabXMLGenerator:
    ...
    def create_label_link_element(self, xlink_role=None, xlink_title=None):
        return ET.Element(
            "link:labelLink",
            attrib={
    ...
    def create_label_element(self, id=None, xlink_label=None):
        return ET.Element(
            "link:label",
            attrib={
                "id": id,
    ...
    def create_label_loc_element(self, label=None, xlink_href=None):
        return ET.Element(
            "link:loc",
            attrib={
                "xlink:type": "locator",
    ...
    def create_label_arc_element(
        self, order=None, arc_role=None, xlink_from=None, xlink_to=None
    ):
        return ET.Element(
            "link:labelArc",
            attrib={
