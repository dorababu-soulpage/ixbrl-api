html_elements_data: list[dict] = [
    # Def XML Elements
    {
        ...
        "Calculation": "",
        "Period": "",
        "Axis_Member": "us-gaap--StatementClassOfStockAxis_dummy--CommonStock025ParValueMember__us-gaap--ClassOfFinancingReceivableTypeOfBorrowerAxis_us-gaap--ConsumerBorrowerMember__us-gaap--FinancingReceivableRecordedInvestmentByClassOfFinancingReceivableAxis_us-gaap--AutomobileLoanMember",
        "Domain": "us-gaap--ClassOfStockDomain",
        "PreferredLabel": "Land",
